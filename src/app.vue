...
<template>
  <div class="flex h-screen">
    ...
    <div class="w-64 bg-gray-800 text-white p-4">
      ...
      <ul class="space-y-2">
        <li><RouterLink to="/monster-reward" class="block p-2 rounded hover:bg-gray-700" active-class="bg-gray-700 text-yellow-300">掉落物管理</RouterLink></li>
        ...
        <li><RouterLink to="/maps" class="block p-2 rounded hover:bg-gray-700" active-class="bg-gray-700 text-yellow-300">地圖管理</RouterLink></li>
